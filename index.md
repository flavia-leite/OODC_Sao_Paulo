...
<br>
### INTRODUCTION
The **Outorga Onerosa do Direito de Construir (OODC)** - or the onerous grant of the right to build - is one of Brazil's main instruments of municipal urban planning. The OODC was brought in by the 2001 Statute of the City (Estatuto da Cidade), the national law regulating the Brazilian Constitution's articles on urban policy. The OODC regulates the payment by developers of additional building rights - developers who want to build beyond a specific Floor Area Ration (FAR) have to pay the OODC to a municipality.

The resources generated by the OODC in each city are deposited into a reserve fund used to provide urban improvements of social interest across a municipality. The OODC's basic principle is that funds captured in the most expensive regions of a city should be redistributed to lower-income areas, benefiting the common interest. This "Robin Hood" approach to city building was conceived by the Statute of the City, which is profoundly driven by equity principles. 
...
<iframe is="x-frame-bypass" style="width: 70; border: 0px" src="https://github.com/flavia-leite/OODC_Sao_Paulo/blob/a461c9ec0d9099a2a0e25f03034a36ad0a6c6144/m.html" > </iframe>
...
The two charts below show  OODC revenues and spending over the years. Due to limited data availability, the charts present figures only from 2013 to 2020. During this period, R$ 2.8 billion ($0.6 billion) were raised by the OODC. Between 2019 and 2020, lower interest rates benefited the real estate market, boosting OODC revenues. Also, changes made to São Paulo's master plan in 2014 altered the standardized formula used to calculate the charge levied on developers via the ODDC, increasing revenue generation.
...
Between 2013 and 2020, R$2.2billion ($0.44 billion) of OODC revenues were spent - 40% of that amount was disbursed in the last two years. 
...
<br>
### METHODOLOGY
In São Paulo, OODC revenues have a **redistributive purpose**; revenues collected in the most developed parts of the city should be spent on the most vulnerable areas. Given this redistributive goal, my project aims to answer the following set of questions: 
...
For the purposes of this study, I only utilized OODC data from 2013 to 2020, since that is what the city of São Paulo has available on its website. 
To analyze the OODC data I imported all of the data as .csv files and used python and pandas to join appropriate datasets and clean up each dataframe to provide consistent information on the following fields: latitude, longitude, OODC paid by each project, amount invested in each district. For the specific case of data on OODC housing spending, I had to geolocate addresses, using the Geopy python library.

I also used 2010 census data provided by IBGE, to get data on income and household characteristics. I downloaded shp. files of census tracks and district boundaries from their website. I downloaded the income and household data from the API of [Base dos dados](https://basedosdados.github.io/mais/api_reference_python/), a website that provides cleaned IBGE dataframes.

Finally, it is worth noting that since I worked with data from Brazil, I had to transform some numbers. In the US, cents are separated by a decimal point, and thousands are separated by a comma. But in Brazil, it is the opposite. I also had to translate most of the table headings. 
...
Spending of OODC funds has not been uniform either. As the map below shows, between 2013 and 2020, spending was concentrated in the São Paulo's historic center and in some peripheral districts in the South and East parts of the city, where low-income households are concentrated. Still, the amount spent in many poor communities was very low, ranging between $5million and $17million, corresponding to the amount spent on many high-income areas in the southwest region.
...
Another way of looking at the same question is observing the map below. This map shows the ratio of OODC spending to OODC revenues by District. A percentage higher than one means that OODC spending in a district was higher than its revenues. Considering the OODC redistributive purposes, we expect to see higher ratios in low-income districts (predominantly located in the periphery and the city's historic center). And that is what we found!
...
A closer look at the breakdown of OODC spending according to district type shows a more heterogeneous picture. Spending on Central districts, with few parks and a deteriorated housing stock, was concentrated on green spaces (36%) and social housing (39%). Similarly, in low-income districts, OODC spending was targeted at housing (47%), transportation (27%), and Water and sanitation projects (19%).In upper-middle-class districts, on the other hand, more than half of spending went to transportation projects. 
...
Providing an even more detailed look at the OODC spending, we can see how FUNDURB revenues have been used to fund social housing-related investments. As described above, not all of this investment refers to housing projects; most relate to acquiring land to develop social housing, regularizing land tenure, and upgrading favelas. The map below (_click on the image to see the interactive map!_) shows how these investments are spread throughout the city and the average income per household per census tract (the smallest territorial unity for which data are available). Most social housing-related investments are on the east side of the city (the lowest income region of São Paulo) and on the southwest region (the highest income region where the city plans to bring more social housing).
...
The brief analysis tried to show whether the OODC managed to accomplish its central goal of trading development rights for community benefits. Overall, the OODC managed to capture funds in the wealthiest districts and apply them in the city's poorest areas, accomplishing its "Robin Hood" goals. In terms of spending, most of it was concentrated in peripheral districts and in the historic city center, areas that have a strong need for public investment. It is worth noting that ODDC spending was unequal within low-income districts. The amount spent on some low-income communities between 2013 and 20202 was still meager; many of those districts received less than R$20million ($4 million), an amount insufficient to bring meaningful urban investments. Still, the analysis above shows that, even in these cases, low-income districts generally obtained more OODC spending than what they generated, and vice-versa. Finally, the OODC spending focus on housing and transportation shows that the instrument is being implemented in line with its overarching principles.

This project could benefit from more granular data on OODC revenues and expenditures. While it was possible to geolocate addresses for OODC housing investments, the same was not valid for other categories since addresses were poorly formated or did not exist. If the city could provide georeferenced information for all investments related to OODC revenues, we could better understand the instrument's redistributive potential.  Additionally, had this data been available on a larger time frame, the study may have shed more light on the how OODC spending varied over time. 
