...
### INTRODUCTION
The **Outorga Onerosa do Direito de Construir (OODC)** - or the onerous grant of the right to build - is one of Brazil's main instruments of municipal urban planning. The OODC was brought in by the 2001 Statute of the City (Estatuto da Cidade), the national law regulating the Brazilian Constitution's articles on urban policy. The OODC regulates the payment of additional building rights - developers aiming to build above a specific Floor Area Ratio (FAR) have to pay the OODC to a municipality.

The resources generated by the OODC in a city are deposited into a reserve fund used to provide urban improvements of social interest across the municipality. The OODC's basic principle is that funds captured in the most expensive regions should be redistributed to lower-income areas, benefiting the common interest. This "Robin Hood" approach to city building was conceived by the Statute of the City, which is profoundly driven by equity principles. 
...
[^1]: As a matter of comparison, São Paulo's budget in 2020 was R$69 billion, while the OODC revenue for that year was R$ 5.4 billion.
